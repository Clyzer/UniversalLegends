...
```json
{
    ...
    "discord": {
        ...
        "smallImageText": "universallegends",
        "smallImageKey": "seal-circle"
    },
    "rss": "https://universallegends.com/articles/index.rss",
    "servers": [
        {
            "id": "Example_Server",
            "name": "universallegends Example Client",
            "description": "Example universallegends server. Connect for fun!",
            "icon": "http://mc.universallegends.com/universallegendsLauncher/files/example_icon.png",
            "version": "0.0.1",
            "address": "mc.universallegends.com:1337",
            "minecraftVersion": "1.11.2",
            "discord": {
                "shortId": "Example",
                "largeImageText": "universallegends Example Server",
    ...
    "subModules": [
        {
            ...
            "artifact": {
                ...
                "url": "http://mc.universallegends.com/universallegendsLauncher/files/1.11.2/launchwrapper-1.12.jar"
            }
        }
    ]
}
...
```json
{
    ...
    "artifact": {
        ...
        "url": "http://mc.universallegends.com/universallegendsLauncher/files/1.11.2/liteloader-1.11.2.jar"
    },
    "subModules": [
...
```json
{
    ...
    "artifact": {
        ...
        "url": "http://mc.universallegends.com/universallegendsLauncher/files/1.11.2/jopt-simple-4.6.jar"
    }
}
```
...
```json
{
    "id": "com.universallegends:westerosblocks:3.0.0-beta-6-133",
    "name": "WesterosBlocks (3.0.0-beta-6-133)",
    "type": "ForgeMod",
    "artifact": {
        "size": 16321712,
        "MD5": "5a89e2ab18916c18965fc93a0766cc6e",
        "url": "http://mc.universallegends.com/universallegendsLauncher/prod-1.11.2/mods/WesterosBlocks.jar"
    }
}
```
...
```json
{
    ...
    "artifact": {
        ...
        "url": "http://mc.universallegends.com/universallegendsLauncher/prod-1.11.2/mods/macrokeybindmod.litemod"
    }
}
```
...
```json
{
    "id": "com.universallegends:universallegendsrp:2017-08-16",
    "name": "universallegends Resource Pack (2017-08-16)",
    "type": "file",
     "artifact": {
        "size": 45241339,
        "MD5": "ec2d9fdb14d5c2eafe5975a240202f1a",
        "path": "resourcepacks/universallegends.zip",
        "url": "http://mc.universallegends.com/universallegendsLauncher/prod-1.11.2/resourcepacks/universallegends.zip"
    }
}
```
