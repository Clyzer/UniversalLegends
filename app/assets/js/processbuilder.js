...
class ProcessBuilder {
    ...
    _constructJVMArguments112(mods, tempNativePath){
        ...
        if(process.platform === 'darwin'){
            args.push('-Xdock:name=UniversalLegends')
    ...
    _constructJVMArguments113(mods, tempNativePath){
        ...
        //args.push('-Dlog4j.configurationFile=D:\\universallegends\\game\\common\\assets\\log_configs\\client-1.12.xml')
                ...
                if(argDiscovery.test(args[i])){
                    ...
                    switch(identifier){
                        ...
                        case 'natives_directory':
                            ...
                            break
                        case 'launcher_name':
                            val = args[i].replace(argDiscovery, 'UniversalLegends')
                            break
